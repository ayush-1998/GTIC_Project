...
const Cart = () => {
  ...
  const minPrice =(product) =>{
    return product.Vendor.reduce((min, b) => Math.min(min, b.offerPrice), product.Vendor[0].offerPrice);
  }
  ...
  const total =() =>{
    ...
    cart.map(product =>{
      ...
      savings += (product.Vendor.hasMin("offerPrice").actualPrice-minPrice(product))*product.quantity;
    })
    ...
    <div className="mycart-container">
      ...
      <div className="cart-container">
        <div className="cart1-container">
          <div className="cart-vendor-logo"><img src="images/image 97.png" alt="cart" /></div>
          {Array.isArray([...amazon]) ? ([...amazon].map((product, key) => {
            return (
              <div className="cart-product-container" key={key}>
                <div className="cart-product-image"><img src={product.image} alt="cart" /></div>
                ...
                <div className="cart-product-price">₹ {(product.Vendor.reduce((min, b) => Math.min(min, b.offerPrice), product.Vendor[0].offerPrice))*product.quantity}</div>
              </div>
            );
          })
          ) : (
          ...
          {/* second vendor start */}
          <div className="cart1-container">
            <div className="cart-vendor-logo"><img src="images/image 98.png" alt="cart" /></div>
            {Array.isArray([...bigBasket]) ? ([...bigBasket].map((product, key) => {
              return (
                <div className="cart-product-container" key={key} >
                  <div className="cart-product-image"><img src={product.image} alt="product" /></div>
                  <div className="cart-productDetail-container">
                    <div className="cart-product-brand">
                  Brand : <span>{product.brand}</span>
                    </div>
                  ...
                  <div className="cart-product-price">₹ {(product.Vendor.reduce((min, b) => Math.min(min, b.offerPrice), product.Vendor[1].offerPrice))*product.quantity}</div>
                </div>
              );
            })
            ) : (
          ...
          {/* Third vendor start */}
          <div className="cart1-container">
            <div className="cart-vendor-logo"><img src="images/image 102.png" alt="cart" /></div>
            {Array.isArray([...blinkit]) ? ([...blinkit].map((product, key) => {
              return (
                <div className="cart-product-container" key={key} >
                  <div className="cart-product-image"><img src={product.image} alt="product" /></div>
                  <div className="cart-productDetail-container">
                  ...
                  <div className="cart-product-price">₹ {(product.Vendor.reduce((min, b) => Math.min(min, b.offerPrice), product.Vendor[2].offerPrice))*product.quantity}</div>
                </div>
              );
            })
            ) : (
